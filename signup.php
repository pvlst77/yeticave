...
if($_SERVER['REQUEST_METHOD']=='POST')
{
    ...
    $contact = clear_data($_POST['contact']);
    ...
    if(!empty($name)&&!empty($contact)&&!empty($email)&&!empty($pass)&&!empty($avatar))
    {
        ...
        {
            $query = "INSERT INTO user (date_regisrtatoin,email,name,pass,avatar,contact) VALUES (now(),'$email','$name','$pass','$avatar','$contact')";
